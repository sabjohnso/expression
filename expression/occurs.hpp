...
namespace Expression
{
  namespace Core
  {
	...
	return aux( integer<T,Index>, type<Body> );
      ...
      static constexpr bool
      aux( Integer<T,Index>, Type<Application<F,A>>){
	return aux( integer<T,Index>, type<F> ) || aux( integer<T,Index>, type<A> );
      }


      template< typename T, T Index, typename E >
      static constexpr bool
      aux( Integer<T,Index>, Type<E> ){
	return false;
      }
    } occurs{};
    ...
    private:
      ...
      static constexpr bool
      aux( Integer<T,Index>, Type<Abstraction<T,Index,Body>> ){
    ...
    private:
      ...
      template< typename T >
      static constexpr bool
      aux( Type<Value<T>> ){ return false; }

      template< typename T, T Index >
      static constexpr bool
      aux( Type<Variable<T,Index>> ){ return true; }
	...
	return aux( type<F> ) || aux( type<A> );
      ...
      template< typename T, T Index, typename Body >
      static constexpr bool
      aux( Type<Abstraction<T,Index,Body>> ){
	...
	return ! ismember( bound_set, integer<T,Index> );
      ...
      static constexpr bool
      aux( Integer_set<T,BoundIndices...> bound_set, Type<Application<F,A>> ){
	return aux( bound_set, type<F> ) || aux( bound_set, type<A> );
      }

      template< typename T, T ... BoundIndices,  T Index, typename Body >
      static constexpr bool
      aux( Integer_set<T, BoundIndices ... > bound_set, Type<Abstraction<T,Index,Body>> ){
	return aux( integer_set_add( bound_set, integer<T,Index> ),
		    type<Body> );
      }
