...
namespace Expression::Core
{
  ...
  public:
    ...
    template<typename U>
    constexpr Let_form(U&& input)
      : binding(forward<U>(input))
    {}
    ...
    operator,( Body&& body ) &&
    {
      return fn(Variable<I, Index>{}, move(body))(expr(move(binding)));
    }

  private:
    constexpr
    operator binding_type&&() &&
    {
      return move(binding);
    }

    constexpr operator binding_type const &() const&
    {
      return move(binding);
    }
  ...
  class Let_form<
    ...
    Binding<I, Index1, E1>,
    Bindings...>
    : tuple<Binding<I, Index0, E0>, Binding<I, Index1, E1>, Bindings...>
  {
  public:
    using base = tuple<
      Binding<I, Index0, E0>,
    ...
    constexpr Let_form(T&& x, U&& y, Vs&&... zs)
  ...
  private:
    ...
    template<size_t index, size_t... indices>
    constexpr auto inner_binding(
      index_sequence<index, indices...>) const&
    {
      return Let_form<Binding<I, Index1, E1>, Bindings...>(
        get<indices>(*this)...);
    }
