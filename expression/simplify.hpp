...
namespace Expression
{
  namespace Core
  {
	...
	return rewrite( body( fun( expr )), Variable<I,Index>{}, arg( expr ));
      }
    ...
    public:
      ...
      template< typename E >
      constexpr auto
      operator ()( const E& expr ) const & { return aux( expr ); }
    ...
    private:
      ...
      static constexpr auto
      aux( const Abstraction<I,Index,Application<F,Variable<I,Index>>>& expr ){
	...
	return fun( Variable<I,Index>{}, aux( body( expr )));
      ...
      template< typename F, typename A >
      static constexpr auto
      aux( const Application<F,A>& expr ){ return aux( fun( expr ))( aux( arg( expr ))); }
