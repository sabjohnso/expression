...
namespace Expression
{
  namespace Core
  {
    ...
    private:
      ...
      static constexpr auto
      aux(const E& expr, const Pat&, const Rep&)
      {
        return expr;
      }
      ...
      static constexpr auto
      aux(
        const Abstraction<I, Index, Body>& expr,
        const Pat& pat,
        const Rep& rep)
      {
        return fn(Variable<I, Index>{}, aux(body(expr), pat, rep));
      }
      ...
      {
        return aux(fun(expr), pat, rep)(aux(arg(expr), pat, rep));
      }
